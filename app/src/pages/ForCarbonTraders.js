                    ...
                    <Grid container spacing={3} alignItems="center">
                        <Grid item xs={12} md={6} alignItems="center">
                            <div className='opening-blurb'>
                                <Typography variant='h3'>The transparent solution to offset your carbon emissions</Typography>
                                <hr />
                                <Typography variant='h6'>
                                    Buy an spekboom NFT and instantly start generating verifaible CarbonCredits.
                                </Typography>
                                {/* <p>
            ...
            <div className='blurb'>
                <Grid container spacing={3} >
                    <Grid item xs={12} md={12} style={{ textAlign: 'center', padding: '5rem' }}>
                        <Typography variant='h3' style={{ color: "white" }}>Burning a carbon credit offsets one tonne of carbon dioxide emissions</Typography>
                    </Grid>
                </Grid>
            </div>
                ...
                <Grid container spacing={3} >
                    ...
                    <Grid item xs={12} md={4} style={{ textAlign: 'center', padding: '2rem' }}>
                        <Paper style={{ padding: '1rem' }}>
                            ...
                            <Typography variant='h6'>Buy a spekboom NFT and set a selling price for this NFT (since it is always for sale). You pay a percentage of the selling price (10% per annum) to hold the token.</Typography>
                        </Paper>
                    </Grid>
                    <Grid item xs={12} md={4} style={{ textAlign: 'center', padding: '2rem' }}>
                        <Paper style={{ padding: '1rem' }}>
                            ...
                            <Typography variant='h6'>Holding the NFT contionusly generates carbon credits (ERC20 tokens) owed to your address.   </Typography>
                        </Paper>
                    </Grid>
                    <Grid item xs={12} md={4} style={{ textAlign: 'center', padding: '2rem' }}>
                        <Paper style={{ padding: '1rem' }}>
                            ...
                            <Typography variant='h6'>Burn the carbon credits to verifiably showcase the offset of your carbon emissions. Otherwise sell them at marketprice and make a profit. </Typography>
                        </Paper>
                    </Grid>
                </Grid>
            </div>
